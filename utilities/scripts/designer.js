...
designer.shapefiles = new (function ()
{
  ...
  var _loaded = function (filename)
  {
    if (shapefile.fields ().length > 0)
    {
      pooch.fetch("#shapefile_name").html (filename.name);
  ...
  _shpScope.loadShapefile = function ()
  {
    ...
    pooch.fetch ("#main_shape_container").css ({ height: "100px" });
    pooch.fetch ("#selectDbfShp").cause ("click");
  };
